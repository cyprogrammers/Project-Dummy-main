"""
backend/tasks/task_model.py
============================
SQLAlchemy ORM model for the tasks table.
Place this file at: backend/tasks/task_model.py

Imports the shared Base from db/database.py — same pattern used by rbac/models.py.

IMPORTANT: Uses PostgreSQL ENUM types that must already exist in the database.
           Run migration_tasks.sql first to create the enum types.
"""
...
# This ensures SQLAlchemy uses the existing database types correctly
