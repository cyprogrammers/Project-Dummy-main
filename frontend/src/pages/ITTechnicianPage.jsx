  ...
  const changeStatus = async (newStatus) => {
    ...
    try {
      const res = await fetch(`${TASKS_API}/${task.id}/status`, {
        ...
        body: JSON.stringify({
          status: newStatus,
          technician_notes: noteText || null,
        }),
      });
      ...
      >
        ...
        <div
          style={{
            width: "4px",
            borderRadius: "4px",
            background: PRI_COLOR[task.priority] || "#9ca3af",
            alignSelf: "stretch",
            flexShrink: 0,
          }}
        />
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            <span
              style={{
                ...
                background: dm ? "rgba(147,197,253,0.1)" : "#ecfeff",
                padding: "1px 7px",
                borderRadius: "4px",
              }}
            >
          ...
          >
            ...
            {task.assigned_by_name && (
              <span>
                👤 Assigned by:{" "}
                <strong style={{ color: dm ? "#94a3b8" : "#374151" }}>
                  {task.assigned_by_name}
                </strong>
              </span>
            )}
            {due && (
              <span
                style={{
                  color: due.overdue && !isDone ? "#ef4444" : "inherit",
                  fontWeight: due.overdue && !isDone ? "700" : "400",
                }}
              >
                {due.overdue && !isDone ? "⚠ " : "📅 "}
                {due.label}
      ...
      {expanded && (
        ...
        >
          ...
          {isDone && task.technician_notes && (
            <div
              style={{
                background: dm ? "#0d2a0d" : "#f0fdf4",
                border: `1px solid ${dm ? "#065f46" : "#bbf7d0"}`,
                borderRadius: "10px",
                padding: "13px 15px",
              }}
            >
              ...
              {task.status === "pending" && (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: "700",
                    cursor: "pointer",
                    opacity: savingStatus === "in_progress" ? 0.7 : 1,
                  }}
                >
                ...
                <>
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: "700",
                      cursor: "pointer",
                      opacity: savingStatus === "completed" ? 0.7 : 1,
                    }}
                  >
          ...
          {toast && (
            <div
              style={{
                ...
                border: `1px solid ${toast.startsWith("✕") ? "#fca5a5" : "#6ee7b7"}`,
              }}
            >
              {toast}
            </div>
...
export default function ITTechnicianPage({ onLogout, currentUser }) {
  ...
  const navItems = NAV_ITEMS_BASE.map((item) =>
    item.id === "maintenance"
      ? { ...item, badge: openTasks.length || null }
      : item,
  );
    ...
    <div style={styles.wrapper}>
      ...
      <main style={styles.main}>
            ...
            <div style={styles.cardGrid4}>
              {[
                ...
                },
                {
                  label: "PENDING TASKS",
                  value: pendingCount || "—",
                  sub: pendingCount ? `${pendingCount} in queue` : "— queue",
                  bg: dm ? "#083344" : "#ecfeff",
            ...
            <section style={styles.statusSection}>
              ...
              <div style={styles.tableWrapper}>
                <table style={styles.table}>
                  <thead>
                    <tr>
                      {["Service", "Status", "Uptime (30d)", "Latency"].map(
                        (h) => (
        ...
        {activePage === "assigned-incidents" && (
          <section style={styles.statusSection}>
            <h2 style={{ ...styles.sectionTitle, margin: "0 0 16px 0" }}>
              My Tickets
            </h2>
            <div style={styles.card}>
              ...
              >
                No incident details are shown yet. Assigned incidents will
                appear here once tasks are assigned.
              </p>
            </div>
          </section>
        )}
            ...
            {p1Count > 0 && (
              ...
              >
                ...
                <div>
                  ...
                  >
                    You have {p1Count} open P1{" "}
                    {p1Count === 1 ? "task" : "tasks"} — Critical priority
                  </div>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    padding: "6px 14px",
                    borderRadius: "20px",
                    border: `1px solid ${filterStatus === s ? "#0891b2" : dm ? "#334155" : "#e5e7eb"}`,
                    background: filterStatus === s ? "#0891b2" : "transparent",
                    color:
                      filterStatus === s ? "white" : dm ? "#94a3b8" : "#374151",
                    fontSize: "12px",
                    fontWeight: "600",
                    cursor: "pointer",
...
const makeStyles = (dm) => ({
  ...
  statusSection: {
    ...
    border: `1px solid ${dm ? "#374151" : "#dbeafe"}`,
    borderRadius: "24px",
